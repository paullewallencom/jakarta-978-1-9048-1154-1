...
<table border="1" width="100%">
 <tr>
   ...
   <td align="center">
   <a href='<%=response.encodeURL("CustomerLogin.jsp")%>'>
   <bean:message key="link.login"/></a></td>
   
   <td align="center">
   <a href='<%=response.encodeURL("Shoppingcart.jsp")%>'>
   <bean:message key="link.viewBasket"/></a></td>
