...
{
   /** SortedSet is already sorted by Title. */
   private SortedSet books = Collections.synchronizedSortedSet(new TreeSet());
   /** The List is not sorted, it allows us to sort by,
      e.g.. Price.*/
   ...
   /** required for the dispaly of Taglibs */
   public List getList() {
      return this.list;
   }
   ...
   /**
      Sorts the books by price, shellSort Time consuming: n^(6/5))
   */
